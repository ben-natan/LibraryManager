...
<body>
  ...
  <main>
    <section class="content">
      ...
      <div class="row">
      <div class="container">
      <h5>Suppression du membre n°${membre.getId()}</h5> 
        <div class="row">
          <p>Êtes-vous sûr de vouloir supprimer la fiche de ${membre.getPrenom()} ${membre.getNom()} ?</p> 
	      <form action="/LibraryManager/membre_delete" method="post" class="col s12">
	        ...
	        <div class="row center">
	          ...
	          <a class="btn waves-effect waves-light orange" href="/LibraryManager/membre_details?id=${membre.getId()}">Annuler</a>
	        </div>
	      </form>
	    </div>	    
      </div>
